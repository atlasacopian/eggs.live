...
// Type for egg types to ensure consistency
...
export interface EggPrice {
  ...
  eggType: EggType | string // Either "regular" or "organic"
...
export interface MarketStats {
  nationalAverage: {
    regular: number // Average price for a dozen regular eggs
    organic: number // Average price for a dozen organic eggs
  }
...
export function isValidEggType(type: string): boolean {
  return type === "regular" || type === "organic"
}
